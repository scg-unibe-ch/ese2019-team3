...
const tty_1 = require("@angular/cli/utilities/tty");
...
exports.AnalyticsProperties = {
    ...
    get AngularCliDefault() {
        ...
        const v = require('@angular/cli/package.json').version;
...
class UniversalAnalytics {
    ...
    constructor(trackingId, uid) {
        ...
        this._ua.set('an', require('@angular/cli/package.json').name);
        this._ua.set('av', require('@angular/cli/package.json').version);
