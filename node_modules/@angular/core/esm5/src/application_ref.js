...
import { ApplicationInitStatus } from '@angular/core/esm5/src/application_init';
import { APP_BOOTSTRAP_LISTENER, PLATFORM_INITIALIZER } from '@angular/core/esm5/src/application_tokens';
import { getCompilerFacade } from '@angular/core/esm5/src/compiler/compiler_facade';
import { Console } from '@angular/core/esm5/src/console';
import { Injectable, InjectionToken, Injector } from '@angular/core/esm5/src/di';
import { ErrorHandler } from '@angular/core/esm5/src/error_handler';
import { DEFAULT_LOCALE_ID } from '@angular/core/esm5/src/i18n/localization';
import { LOCALE_ID } from '@angular/core/esm5/src/i18n/tokens';
import { ivyEnabled } from '@angular/core/esm5/src/ivy_switch';
import { COMPILER_OPTIONS, CompilerFactory } from '@angular/core/esm5/src/linker/compiler';
import { ComponentFactory } from '@angular/core/esm5/src/linker/component_factory';
import { ComponentFactoryBoundToModule, ComponentFactoryResolver } from '@angular/core/esm5/src/linker/component_factory_resolver';
import { NgModuleRef } from '@angular/core/esm5/src/linker/ng_module_factory';
import { isComponentResourceResolutionQueueEmpty, resolveComponentResources } from '@angular/core/esm5/src/metadata/resource_loading';
import { wtfCreateScope, wtfLeave } from '@angular/core/esm5/src/profile/profile';
import { assertNgModuleType } from '@angular/core/esm5/src/render3/assert';
import { setLocaleId } from '@angular/core/esm5/src/render3/i18n';
import { NgModuleFactory as R3NgModuleFactory } from '@angular/core/esm5/src/render3/ng_module_ref';
import { Testability, TestabilityRegistry } from '@angular/core/esm5/src/testability/testability';
import { isDevMode } from '@angular/core/esm5/src/util/is_dev_mode';
import { isPromise } from '@angular/core/esm5/src/util/lang';
import { scheduleMicroTask } from '@angular/core/esm5/src/util/microtask';
import { stringify } from '@angular/core/esm5/src/util/stringify';
import { NgZone, NoopNgZone } from '@angular/core/esm5/src/zone/ng_zone';
var _platform;
