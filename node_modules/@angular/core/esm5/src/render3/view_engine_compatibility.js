...
import { NgModuleRef as viewEngine_NgModuleRef } from '@angular/core/esm5/src/linker/ng_module_factory';
import { addToArray, removeFromArray } from '@angular/core/esm5/src/util/array_utils';
import { assertDefined, assertGreaterThan, assertLessThan } from '@angular/core/esm5/src/util/assert';
import { assertLContainer } from '@angular/core/esm5/src/render3/assert';
import { NodeInjector, getParentInjectorLocation } from '@angular/core/esm5/src/render3/di';
import { addToViewTree, createEmbeddedViewAndNode, createLContainer, renderEmbeddedTemplate } from '@angular/core/esm5/src/render3/instructions/shared';
import { ACTIVE_INDEX, CONTAINER_HEADER_OFFSET, VIEW_REFS } from '@angular/core/esm5/src/render3/interfaces/container';
import { isProceduralRenderer } from '@angular/core/esm5/src/render3/interfaces/renderer';
import { isComponent, isLContainer, isLView, isRootView } from '@angular/core/esm5/src/render3/interfaces/type_checks';
import { CONTEXT, DECLARATION_LCONTAINER, QUERIES, RENDERER, T_HOST } from '@angular/core/esm5/src/render3/interfaces/view';
import { assertNodeOfPossibleTypes } from '@angular/core/esm5/src/render3/node_assert';
import { addRemoveViewFromContainer, appendChild, detachView, getBeforeNodeForView, insertView, nativeInsertBefore, nativeNextSibling, nativeParentNode, removeView } from '@angular/core/esm5/src/render3/node_manipulation';
import { getParentInjectorTNode } from '@angular/core/esm5/src/render3/node_util';
import { getLView, getPreviousOrParentTNode } from '@angular/core/esm5/src/render3/state';
import { getParentInjectorView, hasParentInjector } from '@angular/core/esm5/src/render3/util/injector_utils';
import { findComponentView } from '@angular/core/esm5/src/render3/util/view_traversal_utils';
import { getComponentViewByIndex, getNativeByTNode, unwrapRNode, viewAttachedToContainer } from '@angular/core/esm5/src/render3/util/view_utils';
import { ViewRef } from '@angular/core/esm5/src/render3/view_ref';
/**
