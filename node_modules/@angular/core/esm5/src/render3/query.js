...
import { QueryList } from '@angular/core/esm5/src/linker/query_list';
import { TemplateRef as ViewEngine_TemplateRef } from '@angular/core/esm5/src/linker/template_ref';
import { ViewContainerRef } from '@angular/core/esm5/src/linker/view_container_ref';
import { assertDataInRange, assertDefined, throwError } from '@angular/core/esm5/src/util/assert';
import { stringify } from '@angular/core/esm5/src/util/stringify';
import { assertFirstTemplatePass, assertLContainer } from '@angular/core/esm5/src/render3/assert';
import { getNodeInjectable, locateDirectiveOrProvider } from '@angular/core/esm5/src/render3/di';
import { storeCleanupWithContext } from '@angular/core/esm5/src/render3/instructions/shared';
import { CONTAINER_HEADER_OFFSET, MOVED_VIEWS } from '@angular/core/esm5/src/render3/interfaces/container';
import { unusedValueExportToPlacateAjd as unused1 } from '@angular/core/esm5/src/render3/interfaces/definition';
import { unusedValueExportToPlacateAjd as unused2 } from '@angular/core/esm5/src/render3/interfaces/injector';
import { unusedValueExportToPlacateAjd as unused3 } from '@angular/core/esm5/src/render3/interfaces/node';
import { unusedValueExportToPlacateAjd as unused4 } from '@angular/core/esm5/src/render3/interfaces/query';
import { DECLARATION_LCONTAINER, PARENT, QUERIES, TVIEW } from '@angular/core/esm5/src/render3/interfaces/view';
import { assertNodeOfPossibleTypes } from '@angular/core/esm5/src/render3/node_assert';
import { getCurrentQueryIndex, getLView, getPreviousOrParentTNode, isCreationMode, setCurrentQueryIndex } from '@angular/core/esm5/src/render3/state';
import { createContainerRef, createElementRef, createTemplateRef } from '@angular/core/esm5/src/render3/view_engine_compatibility';
