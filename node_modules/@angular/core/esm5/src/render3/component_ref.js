...
import { InjectionToken } from '@angular/core/esm5/src/di/injection_token';
import { ComponentFactory as viewEngine_ComponentFactory, ComponentRef as viewEngine_ComponentRef } from '@angular/core/esm5/src/linker/component_factory';
import { ComponentFactoryResolver as viewEngine_ComponentFactoryResolver } from '@angular/core/esm5/src/linker/component_factory_resolver';
import { ElementRef as viewEngine_ElementRef } from '@angular/core/esm5/src/linker/element_ref';
import { RendererFactory2 } from '@angular/core/esm5/src/render/api';
import { Sanitizer } from '@angular/core/esm5/src/sanitization/security';
import { VERSION } from '@angular/core/esm5/src/version';
import { NOT_FOUND_CHECK_ONLY_ELEMENT_INJECTOR } from '@angular/core/esm5/src/view/provider';
import { assertComponentType } from '@angular/core/esm5/src/render3/assert';
import { LifecycleHooksFeature, createRootComponent, createRootComponentView, createRootContext } from '@angular/core/esm5/src/render3/component';
import { getComponentDef } from '@angular/core/esm5/src/render3/definition';
import { NodeInjector } from '@angular/core/esm5/src/render3/di';
import { addToViewTree, assignTViewNodeToLView, createLView, createTView, elementCreate, locateHostElement, refreshDescendantViews } from '@angular/core/esm5/src/render3/instructions/shared';
import { domRendererFactory3, isProceduralRenderer } from '@angular/core/esm5/src/render3/interfaces/renderer';
import { TVIEW } from '@angular/core/esm5/src/render3/interfaces/view';
import { enterView, leaveView, namespaceHTMLInternal } from '@angular/core/esm5/src/render3/state';
import { defaultScheduler } from '@angular/core/esm5/src/render3/util/misc_utils';
import { getTNode } from '@angular/core/esm5/src/render3/util/view_utils';
import { createElementRef } from '@angular/core/esm5/src/render3/view_engine_compatibility';
import { RootViewRef } from '@angular/core/esm5/src/render3/view_ref';
