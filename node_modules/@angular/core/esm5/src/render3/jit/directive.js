...
import { resolveForwardRef } from '@angular/core/esm5/src/di/forward_ref';
import { compileInjectable } from '@angular/core/esm5/src/di/jit/injectable';
import { getReflect, reflectDependencies } from '@angular/core/esm5/src/di/jit/util';
import { componentNeedsResolution, maybeQueueResolutionOfComponentResources } from '@angular/core/esm5/src/metadata/resource_loading';
import { ViewEncapsulation } from '@angular/core/esm5/src/metadata/view';
import { getBaseDef, getComponentDef, getDirectiveDef } from '@angular/core/esm5/src/render3/definition';
import { EMPTY_ARRAY, EMPTY_OBJ } from '@angular/core/esm5/src/render3/empty';
import { NG_BASE_DEF, NG_COMPONENT_DEF, NG_DIRECTIVE_DEF } from '@angular/core/esm5/src/render3/fields';
import { stringifyForError } from '@angular/core/esm5/src/render3/util/misc_utils';
import { angularCoreEnv } from '@angular/core/esm5/src/render3/jit/environment';
import { flushModuleScopingQueueAsMuchAsPossible, patchComponentDefWithScope, transitiveScopesFor } from '@angular/core/esm5/src/render3/jit/module';
/**
