...
import { ViewEncapsulation } from '@angular/core/esm5/src/metadata/view';
import { addToArray, removeFromArray } from '@angular/core/esm5/src/util/array_utils';
import { assertDefined, assertDomNode } from '@angular/core/esm5/src/util/assert';
import { assertLContainer, assertLView } from '@angular/core/esm5/src/render3/assert';
import { attachPatchData } from '@angular/core/esm5/src/render3/context_discovery';
import { CONTAINER_HEADER_OFFSET, MOVED_VIEWS, NATIVE, unusedValueExportToPlacateAjd as unused1 } from '@angular/core/esm5/src/render3/interfaces/container';
import { NodeInjectorFactory } from '@angular/core/esm5/src/render3/interfaces/injector';
import { unusedValueExportToPlacateAjd as unused2 } from '@angular/core/esm5/src/render3/interfaces/node';
import { unusedValueExportToPlacateAjd as unused3 } from '@angular/core/esm5/src/render3/interfaces/projection';
import { isProceduralRenderer, unusedValueExportToPlacateAjd as unused4 } from '@angular/core/esm5/src/render3/interfaces/renderer';
import { isLContainer, isLView, isRootView } from '@angular/core/esm5/src/render3/interfaces/type_checks';
import { CHILD_HEAD, CLEANUP, DECLARATION_LCONTAINER, FLAGS, HOST, NEXT, PARENT, QUERIES, RENDERER, TVIEW, T_HOST, unusedValueExportToPlacateAjd as unused5 } from '@angular/core/esm5/src/render3/interfaces/view';
import { assertNodeOfPossibleTypes, assertNodeType } from '@angular/core/esm5/src/render3/node_assert';
import { renderStringify } from '@angular/core/esm5/src/render3/util/misc_utils';
import { findComponentView, getLViewParent } from '@angular/core/esm5/src/render3/util/view_traversal_utils';
import { getNativeByTNode, getNativeByTNodeOrNull, unwrapRNode } from '@angular/core/esm5/src/render3/util/view_utils';
