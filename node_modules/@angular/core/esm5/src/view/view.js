 ...
 */
import { checkAndUpdateElementDynamic, checkAndUpdateElementInline, createElement, listenToElementOutputs } from '@angular/core/esm5/src/view/element';
import { expressionChangedAfterItHasBeenCheckedError } from '@angular/core/esm5/src/view/errors';
import { appendNgContent } from '@angular/core/esm5/src/view/ng_content';
import { callLifecycleHooksChildrenFirst, checkAndUpdateDirectiveDynamic, checkAndUpdateDirectiveInline, createDirectiveInstance, createPipeInstance, createProviderInstance } from '@angular/core/esm5/src/view/provider';
import { checkAndUpdatePureExpressionDynamic, checkAndUpdatePureExpressionInline, createPureExpression } from '@angular/core/esm5/src/view/pure_expression';
import { checkAndUpdateQuery, createQuery } from '@angular/core/esm5/src/view/query';
import { createTemplateData, createViewContainerData } from '@angular/core/esm5/src/view/refs';
import { checkAndUpdateTextDynamic, checkAndUpdateTextInline, createText } from '@angular/core/esm5/src/view/text';
import { Services, asElementData, asQueryList, asTextData, shiftInitState } from '@angular/core/esm5/src/view/types';
import { NOOP, checkBindingNoChanges, isComponentView, markParentViewsForCheckProjectedViews, resolveDefinition, tokenKey } from '@angular/core/esm5/src/view/util';
import { detachProjectedView } from '@angular/core/esm5/src/view/view_attach';
