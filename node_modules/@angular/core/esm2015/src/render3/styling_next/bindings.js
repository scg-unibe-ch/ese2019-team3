 ...
 */
import { RendererStyleFlags3, isProceduralRenderer } from '@angular/core/esm2015/src/render3/interfaces/renderer';
import { BIT_MASK_START_VALUE, deleteStylingStateFromStorage, getStylingState, resetStylingState, storeStylingState } from '@angular/core/esm2015/src/render3/styling_next/state';
import { allowStylingFlush, getBindingValue, getGuardMask, getMapProp, getMapValue, getProp, getPropValuesStartPosition, getStylingMapArray, getValuesCount, hasValueChanged, isContextLocked, isSanitizationRequired, isStylingValueDefined, lockContext, setGuardMask, stateIsPersisted } from '@angular/core/esm2015/src/render3/styling_next/util';
