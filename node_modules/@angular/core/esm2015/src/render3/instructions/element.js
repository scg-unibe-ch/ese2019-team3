 ...
 */
import { assertDataInRange, assertDefined, assertEqual } from '@angular/core/esm2015/src/util/assert';
import { assertHasParent } from '@angular/core/esm2015/src/render3/assert';
import { attachPatchData } from '@angular/core/esm2015/src/render3/context_discovery';
import { registerPostOrderHooks } from '@angular/core/esm2015/src/render3/hooks';
import { isContentQueryHost } from '@angular/core/esm2015/src/render3/interfaces/type_checks';
import { BINDING_INDEX, HEADER_OFFSET, RENDERER, TVIEW, T_HOST } from '@angular/core/esm2015/src/render3/interfaces/view';
import { assertNodeType } from '@angular/core/esm2015/src/render3/node_assert';
import { appendChild } from '@angular/core/esm2015/src/render3/node_manipulation';
import { decreaseElementDepthCount, getElementDepthCount, getIsParent, getLView, getPreviousOrParentTNode, getSelectedIndex, increaseElementDepthCount, setIsNotParent, setPreviousOrParentTNode } from '@angular/core/esm2015/src/render3/state';
import { registerInitialStylingOnTNode } from '@angular/core/esm2015/src/render3/styling_next/instructions';
import { getInitialStylingValue, hasClassInput, hasStyleInput } from '@angular/core/esm2015/src/render3/styling_next/util';
import { setUpAttributes } from '@angular/core/esm2015/src/render3/util/attrs_utils';
import { getNativeByTNode, getTNode } from '@angular/core/esm2015/src/render3/util/view_utils';
import { createDirectivesAndLocals, elementCreate, executeContentQueries, getOrCreateTNode, initializeTNodeInputs, renderInitialStyling, resolveDirectives, setInputsForProperty } from '@angular/core/esm2015/src/render3/instructions/shared';
/**
