 ...
 */
import { ErrorHandler } from '@angular/core/esm2015/src/error_handler';
import { CUSTOM_ELEMENTS_SCHEMA, NO_ERRORS_SCHEMA } from '@angular/core/esm2015/src/metadata/schema';
import { validateAgainstEventAttributes, validateAgainstEventProperties } from '@angular/core/esm2015/src/sanitization/sanitization';
import { assertDataInRange, assertDefined, assertDomNode, assertEqual, assertGreaterThan, assertNotEqual, assertNotSame } from '@angular/core/esm2015/src/util/assert';
import { createNamedArrayType } from '@angular/core/esm2015/src/util/named_array_type';
import { normalizeDebugBindingName, normalizeDebugBindingValue } from '@angular/core/esm2015/src/util/ng_reflect';
import { assertLView, assertPreviousIsParent } from '@angular/core/esm2015/src/render3/assert';
import { attachPatchData, getComponentViewByInstance } from '@angular/core/esm2015/src/render3/context_discovery';
import { diPublicInInjector, getNodeInjectable, getOrCreateNodeInjectorForNode } from '@angular/core/esm2015/src/render3/di';
import { throwMultipleComponentError } from '@angular/core/esm2015/src/render3/errors';
import { executeHooks, executePreOrderHooks, registerPreOrderHooks } from '@angular/core/esm2015/src/render3/hooks';
import { ACTIVE_INDEX, CONTAINER_HEADER_OFFSET } from '@angular/core/esm2015/src/render3/interfaces/container';
import { INJECTOR_BLOOM_PARENT_SIZE, NodeInjectorFactory } from '@angular/core/esm2015/src/render3/interfaces/injector';
import { isProceduralRenderer } from '@angular/core/esm2015/src/render3/interfaces/renderer';
import { isComponent, isComponentDef, isContentQueryHost, isLContainer, isRootView } from '@angular/core/esm2015/src/render3/interfaces/type_checks';
import { BINDING_INDEX, CHILD_HEAD, CHILD_TAIL, CLEANUP, CONTEXT, DECLARATION_VIEW, FLAGS, HEADER_OFFSET, HOST, INJECTOR, NEXT, PARENT, RENDERER, RENDERER_FACTORY, SANITIZER, TVIEW, T_HOST } from '@angular/core/esm2015/src/render3/interfaces/view';
import { assertNodeOfPossibleTypes, assertNodeType } from '@angular/core/esm2015/src/render3/node_assert';
import { isNodeMatchingSelectorList } from '@angular/core/esm2015/src/render3/node_selector_matcher';
import { enterView, getBindingsEnabled, getCheckNoChangesMode, getIsParent, getLView, getNamespace, getPreviousOrParentTNode, getSelectedIndex, incrementActiveDirectiveId, isCreationMode, leaveView, namespaceHTMLInternal, setActiveHostElement, setBindingRoot, setCheckNoChangesMode, setCurrentDirectiveDef, setCurrentQueryIndex, setPreviousOrParentTNode, setSelectedIndex } from '@angular/core/esm2015/src/render3/state';
import { renderStylingMap } from '@angular/core/esm2015/src/render3/styling_next/bindings';
import { NO_CHANGE } from '@angular/core/esm2015/src/render3/tokens';
import { ANIMATION_PROP_PREFIX, isAnimationProp } from '@angular/core/esm2015/src/render3/util/attrs_utils';
import { INTERPOLATION_DELIMITER, renderStringify, stringifyForError } from '@angular/core/esm2015/src/render3/util/misc_utils';
import { getLViewParent, getRootContext } from '@angular/core/esm2015/src/render3/util/view_traversal_utils';
import { getComponentViewByIndex, getNativeByIndex, getNativeByTNode, getTNode, readPatchedLView, resetPreOrderHookFlags, unwrapRNode, viewAttachedToChangeDetector } from '@angular/core/esm2015/src/render3/util/view_utils';
import { LCleanup, LViewBlueprint, MatchesArray, TCleanup, TNodeConstructor, TNodeInitialData, TNodeInitialInputs, TNodeLocalNames, TViewComponents, TViewConstructor, attachLContainerDebug, attachLViewDebug, cloneToLView, cloneToTViewData } from '@angular/core/esm2015/src/render3/instructions/lview_debug';
import { selectInternal } from '@angular/core/esm2015/src/render3/instructions/select';
const ɵ0 = /**
 * @return {?}
 */
