...
import { ClassMetadataMap } from '@angular/core/schematics/migrations/static-queries/angular/ng_query_visitor';
import { NgQueryDefinition } from '@angular/core/schematics/migrations/static-queries/angular/query-definition';
import { TimingResult, TimingStrategy } from '@angular/core/schematics/migrations/static-queries/strategies/timing-strategy';
/**
