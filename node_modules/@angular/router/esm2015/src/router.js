...
import { standardizeConfig, validateConfig } from '@angular/router/esm2015/src/config';
import { createRouterState } from '@angular/router/esm2015/src/create_router_state';
import { createUrlTree } from '@angular/router/esm2015/src/create_url_tree';
import { GuardsCheckEnd, GuardsCheckStart, NavigationCancel, NavigationEnd, NavigationError, NavigationStart, ResolveEnd, ResolveStart, RouteConfigLoadEnd, RouteConfigLoadStart, RoutesRecognized } from '@angular/router/esm2015/src/events';
import { activateRoutes } from '@angular/router/esm2015/src/operators/activate_routes';
import { applyRedirects } from '@angular/router/esm2015/src/operators/apply_redirects';
import { checkGuards } from '@angular/router/esm2015/src/operators/check_guards';
import { recognize } from '@angular/router/esm2015/src/operators/recognize';
import { resolveData } from '@angular/router/esm2015/src/operators/resolve_data';
import { switchTap } from '@angular/router/esm2015/src/operators/switch_tap';
import { DefaultRouteReuseStrategy } from '@angular/router/esm2015/src/route_reuse_strategy';
import { RouterConfigLoader } from '@angular/router/esm2015/src/router_config_loader';
import { createEmptyState } from '@angular/router/esm2015/src/router_state';
import { isNavigationCancelingError, navigationCancelingError } from '@angular/router/esm2015/src/shared';
import { DefaultUrlHandlingStrategy } from '@angular/router/esm2015/src/url_handling_strategy';
import { containsTree, createEmptyUrlTree } from '@angular/router/esm2015/src/url_tree';
import { getAllRouteGuards } from '@angular/router/esm2015/src/utils/preactivation';
import { isUrlTree } from '@angular/router/esm2015/src/utils/type_guards';
/**
 * \@description
 *
