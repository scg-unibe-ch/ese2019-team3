...
import { LoadedRouterConfig } from '@angular/router/esm5/src/config';
import { PRIMARY_OUTLET, defaultUrlMatcher, navigationCancelingError } from '@angular/router/esm5/src/shared';
import { UrlSegmentGroup, UrlTree } from '@angular/router/esm5/src/url_tree';
import { forEach, waitForMap, wrapIntoObservable } from '@angular/router/esm5/src/utils/collection';
import { isCanLoad, isFunction } from '@angular/router/esm5/src/utils/type_guards';
