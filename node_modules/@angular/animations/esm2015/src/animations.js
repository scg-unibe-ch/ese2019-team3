 ...
 */
export { AnimationBuilder, AnimationFactory } from '@angular/animations/esm2015/src/animation_builder';
export { AUTO_STYLE, animate, animateChild, animation, group, keyframes, query, sequence, stagger, state, style, transition, trigger, useAnimation } from '@angular/animations/esm2015/src/animation_metadata';
export { NoopAnimationPlayer } from '@angular/animations/esm2015/src/players/animation_player';
export { ɵAnimationGroupPlayer, ɵPRE_STYLE } from '@angular/animations/esm2015/src/private_export';
