 ...
 */
import { allowPreviousPlayerStylesMerge, balancePreviousStylesIntoKeyframes, copyStyles } from '@angular/animations/esm2015/browser/src/util';
import { CssKeyframesDriver } from '@angular/animations/esm2015/browser/src/render/css_keyframes/css_keyframes_driver';
import { containsElement, invokeQuery, isBrowser, matchesElement, validateStyleProperty } from '@angular/animations/esm2015/browser/src/render/shared';
import { packageNonAnimatableStyles } from '@angular/animations/esm2015/browser/src/render/special_cased_styles';
import { WebAnimationsPlayer } from '@angular/animations/esm2015/browser/src/render/web_animations/web_animations_player';
