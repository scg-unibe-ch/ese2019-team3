import { allowPreviousPlayerStylesMerge, balancePreviousStylesIntoKeyframes } from '@angular/animations/esm5/browser/src/util';
import { containsElement, hypenatePropsObject, invokeQuery, matchesElement, validateStyleProperty } from '@angular/animations/esm5/browser/src/render/shared';
import { packageNonAnimatableStyles } from '@angular/animations/esm5/browser/src/render/special_cased_styles';
import { CssKeyframesPlayer } from '@angular/animations/esm5/browser/src/render/css_keyframes/css_keyframes_player';
import { DirectStylePlayer } from '@angular/animations/esm5/browser/src/render/css_keyframes/direct_style_player';
