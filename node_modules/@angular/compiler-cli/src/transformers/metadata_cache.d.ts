...
import { MetadataCollector, MetadataValue, ModuleMetadata } from '@angular/compiler-cli/src/metadata';
import { MetadataProvider } from '@angular/compiler-cli/src/transformers/compiler_host';
