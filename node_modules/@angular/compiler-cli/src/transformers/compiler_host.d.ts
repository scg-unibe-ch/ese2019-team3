...
import { ModuleMetadata } from '@angular/compiler-cli/src/metadata';
import { CompilerHost, CompilerOptions, LibrarySummary } from '@angular/compiler-cli/src/transformers/api';
