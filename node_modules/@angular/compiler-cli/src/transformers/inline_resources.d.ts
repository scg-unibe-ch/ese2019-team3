...
import { MetadataObject, MetadataValue } from '@angular/compiler-cli/src/metadata';
import { MetadataTransformer, ValueTransform } from '@angular/compiler-cli/src/transformers/metadata_cache';
