...
import { DefaultImportRecorder } from '@angular/compiler-cli/src/ngtsc/imports';
import { MetadataRegistry } from '@angular/compiler-cli/src/ngtsc/metadata';
import { PartialEvaluator } from '@angular/compiler-cli/src/ngtsc/partial_evaluator';
import { ClassDeclaration, ClassMember, Decorator, ReflectionHost } from '@angular/compiler-cli/src/ngtsc/reflection';
import { AnalysisOutput, CompileResult, DecoratorHandler, DetectResult, HandlerPrecedence } from '@angular/compiler-cli/src/ngtsc/transform';
