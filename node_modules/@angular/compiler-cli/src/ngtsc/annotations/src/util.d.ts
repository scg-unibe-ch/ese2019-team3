...
import { ForeignFunctionResolver, PartialEvaluator } from '@angular/compiler-cli/src/ngtsc/partial_evaluator';
import { ClassDeclaration, CtorParameter, Decorator, Import, ReflectionHost, TypeValueReference } from '@angular/compiler-cli/src/ngtsc/reflection';
