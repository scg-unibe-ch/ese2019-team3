...
import { DefaultImportRecorder, Reference, ReferenceEmitter } from '@angular/compiler-cli/src/ngtsc/imports';
import { MetadataRegistry } from '@angular/compiler-cli/src/ngtsc/metadata';
...
import { AnalysisOutput, CompileResult, DecoratorHandler, DetectResult, HandlerPrecedence, ResolveResult } from '@angular/compiler-cli/src/ngtsc/transform';
import { ReferencesRegistry } from '@angular/compiler-cli/src/ngtsc/annotations/src/references_registry';
