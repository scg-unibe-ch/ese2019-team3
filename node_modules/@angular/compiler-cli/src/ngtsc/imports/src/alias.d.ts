...
import { FileToModuleHost, ReferenceEmitStrategy } from '@angular/compiler-cli/src/ngtsc/imports/src/emitter';
import { ImportMode, Reference } from '@angular/compiler-cli/src/ngtsc/imports/src/references';
