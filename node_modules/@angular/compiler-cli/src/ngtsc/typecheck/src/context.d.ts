...
import { TypeCheckableDirectiveMeta, TypeCheckingConfig, TypeCtorMetadata } from '@angular/compiler-cli/src/ngtsc/typecheck/src/api';
import { Diagnostic } from '@angular/compiler-cli/src/ngtsc/typecheck/src/diagnostics';
/**
