...
import { TypeCheckingConfig } from '@angular/compiler-cli/src/ngtsc/typecheck/src/api';
import { AbsoluteSpan } from '@angular/compiler-cli/src/ngtsc/typecheck/src/diagnostics';
/**
