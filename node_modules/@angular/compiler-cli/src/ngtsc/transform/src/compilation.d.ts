...
import { TypeCheckContext } from '@angular/compiler-cli/src/ngtsc/typecheck';
import { CompileResult, DecoratorHandler } from '@angular/compiler-cli/src/ngtsc/transform/src/api';
/**
