...
import { CompileResult } from '@angular/compiler-cli/src/ngtsc/transform/src/api';
import { IvyCompilation } from '@angular/compiler-cli/src/ngtsc/transform/src/compilation';
