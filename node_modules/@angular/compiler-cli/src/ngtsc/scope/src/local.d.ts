...
import { AliasGenerator, Reexport, Reference, ReferenceEmitter } from '@angular/compiler-cli/src/ngtsc/imports';
...
import { ExportScope, ScopeData } from '@angular/compiler-cli/src/ngtsc/scope/src/api';
