...
import { TopLevelIdentifier } from '@angular/compiler-cli/src/ngtsc/indexer/src/api';
import { ComponentMeta } from '@angular/compiler-cli/src/ngtsc/indexer/src/context';
/**
