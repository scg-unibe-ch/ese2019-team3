...
import { DependencyTracker, ForeignFunctionResolver } from '@angular/compiler-cli/src/ngtsc/partial_evaluator/src/interface';
import { ResolvedValue } from '@angular/compiler-cli/src/ngtsc/partial_evaluator/src/result';
/**
