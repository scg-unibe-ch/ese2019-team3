...
import { TsHelperFn } from '@angular/compiler-cli/src/ngtsc/reflection';
import { ResolvedValue, ResolvedValueArray } from '@angular/compiler-cli/src/ngtsc/partial_evaluator/src/result';
