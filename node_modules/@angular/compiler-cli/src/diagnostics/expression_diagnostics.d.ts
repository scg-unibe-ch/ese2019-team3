...
import { DiagnosticKind, ExpressionDiagnosticsContext, TypeDiagnostic } from '@angular/compiler-cli/src/diagnostics/expression_type';
import { Span, SymbolQuery, SymbolTable } from '@angular/compiler-cli/src/diagnostics/symbols';
