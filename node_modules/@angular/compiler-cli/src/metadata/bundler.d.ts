...
import { MetadataCache } from '@angular/compiler-cli/src/transformers/metadata_cache';
import { MetadataEntry, ModuleMetadata } from '@angular/compiler-cli/src/metadata/schema';
