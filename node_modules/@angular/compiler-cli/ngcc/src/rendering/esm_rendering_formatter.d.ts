...
import { Import, ImportManager } from '@angular/compiler-cli/src/ngtsc/translator';
import { CompiledClass } from '@angular/compiler-cli/ngcc/src/analysis/types';
import { NgccReflectionHost, SwitchableVariableDeclaration } from '@angular/compiler-cli/ngcc/src/host/ngcc_host';
import { ModuleWithProvidersInfo } from '@angular/compiler-cli/ngcc/src/analysis/module_with_providers_analyzer';
import { ExportInfo } from '@angular/compiler-cli/ngcc/src/analysis/private_declarations_analyzer';
import { RenderingFormatter, RedundantDecoratorMap } from '@angular/compiler-cli/ngcc/src/rendering/rendering_formatter';
/**
