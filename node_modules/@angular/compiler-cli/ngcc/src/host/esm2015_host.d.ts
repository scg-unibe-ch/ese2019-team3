...
import { ClassDeclaration, ClassMember, ClassMemberKind, ClassSymbol, CtorParameter, Declaration, Decorator, TypeScriptReflectionHost } from '@angular/compiler-cli/src/ngtsc/reflection';
import { Logger } from '@angular/compiler-cli/ngcc/src/logging/logger';
import { BundleProgram } from '@angular/compiler-cli/ngcc/src/packages/bundle_program';
import { ModuleWithProvidersFunction, NgccReflectionHost, SwitchableVariableDeclaration } from '@angular/compiler-cli/ngcc/src/host/ngcc_host';
