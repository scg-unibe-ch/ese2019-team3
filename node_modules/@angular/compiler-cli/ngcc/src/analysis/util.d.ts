...
import { ClassSymbol, Decorator } from '@angular/compiler-cli/src/ngtsc/reflection';
import { DecoratorHandler } from '@angular/compiler-cli/src/ngtsc/transform';
import { AnalyzedClass } from '@angular/compiler-cli/ngcc/src/analysis/types';
