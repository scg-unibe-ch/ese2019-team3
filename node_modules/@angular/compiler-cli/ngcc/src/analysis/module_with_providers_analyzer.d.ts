...
import { ReferencesRegistry } from '@angular/compiler-cli/src/ngtsc/annotations';
import { ClassDeclaration, Declaration } from '@angular/compiler-cli/src/ngtsc/reflection';
