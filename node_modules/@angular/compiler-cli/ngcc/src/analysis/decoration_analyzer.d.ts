...
import { ReferencesRegistry, ResourceLoader } from '@angular/compiler-cli/src/ngtsc/annotations';
...
import { ModuleResolver, ReferenceEmitter } from '@angular/compiler-cli/src/ngtsc/imports';
import { CompoundMetadataReader, CompoundMetadataRegistry, DtsMetadataReader, LocalMetadataRegistry } from '@angular/compiler-cli/src/ngtsc/metadata';
import { PartialEvaluator } from '@angular/compiler-cli/src/ngtsc/partial_evaluator';
import { ClassSymbol } from '@angular/compiler-cli/src/ngtsc/reflection';
import { LocalModuleScopeRegistry, MetadataDtsModuleScopeResolver } from '@angular/compiler-cli/src/ngtsc/scope';
import { CompileResult, DecoratorHandler } from '@angular/compiler-cli/src/ngtsc/transform';
import { NgccReflectionHost } from '@angular/compiler-cli/ngcc/src/host/ngcc_host';
import { Migration, MigrationHost } from '@angular/compiler-cli/ngcc/src/migrations/migration';
import { EntryPointBundle } from '@angular/compiler-cli/ngcc/src/packages/entry_point_bundle';
import { AnalyzedClass, AnalyzedFile, CompiledFile, DecorationAnalyses } from '@angular/compiler-cli/ngcc/src/analysis/types';
/**
