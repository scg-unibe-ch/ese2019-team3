...
export { ViewCompiler, findStaticQueryIds, staticViewQueryIds } from '@angular/compiler/src/view_compiler/view_compiler';
...
export { makeBindingParser, parseTemplate, ParseTemplateOptions } from '@angular/compiler/src/render3/view/template';
export { R3Reference } from '@angular/compiler/src/render3/util';
export { compileBaseDefFromMetadata, R3BaseRefMetaData, compileComponentFromMetadata, compileDirectiveFromMetadata, parseHostBindings, ParsedHostBindings, verifyHostBindings } from '@angular/compiler/src/render3/view/compiler';
