 ...
 */
import * as chars from '@angular/compiler/esm5/src/chars';
import { DEFAULT_INTERPOLATION_CONFIG } from '@angular/compiler/esm5/src/ml_parser/interpolation_config';
import { escapeRegExp } from '@angular/compiler/esm5/src/util';
import { ASTWithSource, Binary, BindingPipe, Chain, Conditional, EmptyExpr, FunctionCall, ImplicitReceiver, Interpolation, KeyedRead, KeyedWrite, LiteralArray, LiteralMap, LiteralPrimitive, MethodCall, NonNullAssert, ParseSpan, ParserError, PrefixNot, PropertyRead, PropertyWrite, Quote, SafeMethodCall, SafePropertyRead, TemplateBinding } from '@angular/compiler/esm5/src/expression_parser/ast';
import { EOF, TokenType, isIdentifier, isQuote } from '@angular/compiler/esm5/src/expression_parser/lexer';
