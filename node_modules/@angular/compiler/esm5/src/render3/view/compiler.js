...
import { identifierName, sanitizeIdentifier } from '@angular/compiler/esm5/src/compile_metadata';
import { BindingForm, convertPropertyBinding } from '@angular/compiler/esm5/src/compiler_util/expression_converter';
...
import { CssSelector, SelectorMatcher } from '@angular/compiler/esm5/src/selector';
import { ShadowCss } from '@angular/compiler/esm5/src/shadow_css';
import { CONTENT_ATTR, HOST_ATTR } from '@angular/compiler/esm5/src/style_compiler';
import { error } from '@angular/compiler/esm5/src/util';
import { BoundEvent } from '@angular/compiler/esm5/src/render3/r3_ast';
import { compileFactoryFunction } from '@angular/compiler/esm5/src/render3/r3_factory';
import { Identifiers as R3 } from '@angular/compiler/esm5/src/render3/r3_identifiers';
import { prepareSyntheticListenerFunctionName, prepareSyntheticPropertyName, typeWithParameters } from '@angular/compiler/esm5/src/render3/util';
import { StylingBuilder } from '@angular/compiler/esm5/src/render3/view/styling_builder';
import { BindingScope, TemplateDefinitionBuilder, ValueConverter, makeBindingParser, prepareEventListenerParameters, renderFlagCheckIfStmt, resolveSanitizationFn } from '@angular/compiler/esm5/src/render3/view/template';
import { CONTEXT_NAME, DefinitionMap, RENDER_FLAGS, TEMPORARY_NAME, asLiteral, chainedInstruction, conditionallyCreateMapObjectLiteral, getQueryPredicate, temporaryAllocator } from '@angular/compiler/esm5/src/render3/view/util';
var EMPTY_ARRAY = [];
