...
import { flatten, sanitizeIdentifier } from '@angular/compiler/esm5/src/compile_metadata';
import { BindingForm, BuiltinFunctionCall, convertActionBinding, convertPropertyBinding, convertUpdateArguments } from '@angular/compiler/esm5/src/compiler_util/expression_converter';
import * as core from '@angular/compiler/esm5/src/core';
import { AstMemoryEfficientTransformer, FunctionCall, ImplicitReceiver, Interpolation, LiteralArray, LiteralPrimitive, PropertyRead } from '@angular/compiler/esm5/src/expression_parser/ast';
import { Lexer } from '@angular/compiler/esm5/src/expression_parser/lexer';
import { Parser } from '@angular/compiler/esm5/src/expression_parser/parser';
import * as html from '@angular/compiler/esm5/src/ml_parser/ast';
import { HtmlParser } from '@angular/compiler/esm5/src/ml_parser/html_parser';
import { WhitespaceVisitor } from '@angular/compiler/esm5/src/ml_parser/html_whitespaces';
import { DEFAULT_INTERPOLATION_CONFIG } from '@angular/compiler/esm5/src/ml_parser/interpolation_config';
import { isNgContainer as checkIsNgContainer, splitNsName } from '@angular/compiler/esm5/src/ml_parser/tags';
import { mapLiteral } from '@angular/compiler/esm5/src/output/map_util';
import * as o from '@angular/compiler/esm5/src/output/output_ast';
import { DomElementSchemaRegistry } from '@angular/compiler/esm5/src/schema/dom_element_schema_registry';
import { CssSelector } from '@angular/compiler/esm5/src/selector';
import { BindingParser } from '@angular/compiler/esm5/src/template_parser/binding_parser';
import { error } from '@angular/compiler/esm5/src/util';
import * as t from '@angular/compiler/esm5/src/render3/r3_ast';
import { Identifiers as R3 } from '@angular/compiler/esm5/src/render3/r3_identifiers';
import { htmlAstToRender3Ast } from '@angular/compiler/esm5/src/render3/r3_template_transform';
import { prepareSyntheticListenerFunctionName, prepareSyntheticListenerName, prepareSyntheticPropertyName } from '@angular/compiler/esm5/src/render3/util';
import { I18nContext } from '@angular/compiler/esm5/src/render3/view/i18n/context';
import { I18nMetaVisitor } from '@angular/compiler/esm5/src/render3/view/i18n/meta';
import { getSerializedI18nContent } from '@angular/compiler/esm5/src/render3/view/i18n/serializer';
import { I18N_ICU_MAPPING_PREFIX, TRANSLATION_PREFIX, assembleBoundTextPlaceholders, assembleI18nBoundString, formatI18nPlaceholderName, getTranslationConstPrefix, getTranslationDeclStmts, icuFromI18nMessage, isI18nRootNode, isSingleI18nIcu, metaFromI18nMessage, placeholdersToParams, wrapI18nPlaceholder } from '@angular/compiler/esm5/src/render3/view/i18n/util';
import { StylingBuilder } from '@angular/compiler/esm5/src/render3/view/styling_builder';
import { CONTEXT_NAME, IMPLICIT_REFERENCE, NON_BINDABLE_ATTR, REFERENCE_PREFIX, RENDER_FLAGS, asLiteral, chainedInstruction, getAttrsForDirectiveMatching, getInterpolationArgsLength, invalid, trimTrailingNulls, unsupported } from '@angular/compiler/esm5/src/render3/view/util';
