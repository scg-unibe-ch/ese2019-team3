...
import { isGeneratedFile, stripSummaryForJitFileSuffix, stripSummaryForJitNameSuffix, summaryForJitFileName, summaryForJitName } from '@angular/compiler/esm5/src/aot/util';
var TS = /^(?!.*\.d\.ts$).*\.ts$/;
