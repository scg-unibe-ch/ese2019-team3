 ...
 */
import { componentFactoryName, flatten, identifierName, templateSourceUrl } from '@angular/compiler/esm2015/src/compile_metadata';
import { ConstantPool } from '@angular/compiler/esm2015/src/constant_pool';
import { ViewEncapsulation } from '@angular/compiler/esm2015/src/core';
import { MessageBundle } from '@angular/compiler/esm2015/src/i18n/message_bundle';
import { Identifiers, createTokenForExternalReference } from '@angular/compiler/esm2015/src/identifiers';
import { HtmlParser } from '@angular/compiler/esm2015/src/ml_parser/html_parser';
import { removeWhitespaces } from '@angular/compiler/esm2015/src/ml_parser/html_whitespaces';
import { DEFAULT_INTERPOLATION_CONFIG, InterpolationConfig } from '@angular/compiler/esm2015/src/ml_parser/interpolation_config';
import * as o from '@angular/compiler/esm2015/src/output/output_ast';
import { compileNgModuleFromRender2 as compileR3Module } from '@angular/compiler/esm2015/src/render3/r3_module_compiler';
import { compilePipeFromRender2 as compileR3Pipe } from '@angular/compiler/esm2015/src/render3/r3_pipe_compiler';
import { htmlAstToRender3Ast } from '@angular/compiler/esm2015/src/render3/r3_template_transform';
import { compileComponentFromRender2 as compileR3Component, compileDirectiveFromRender2 as compileR3Directive } from '@angular/compiler/esm2015/src/render3/view/compiler';
...
import { error, syntaxError, visitValue } from '@angular/compiler/esm2015/src/util';
import { GeneratedFile } from '@angular/compiler/esm2015/src/aot/generated_file';
import { listLazyRoutes, parseLazyRoute } from '@angular/compiler/esm2015/src/aot/lazy_routes';
import { StaticSymbol } from '@angular/compiler/esm2015/src/aot/static_symbol';
import { createForJitStub, serializeSummaries } from '@angular/compiler/esm2015/src/aot/summary_serializer';
import { ngfactoryFilePath, normalizeGenFileSuffix, splitTypescriptSuffix, summaryFileName, summaryForJitFileName } from '@angular/compiler/esm2015/src/aot/util';
