...
import { isGeneratedFile, stripSummaryForJitFileSuffix, stripSummaryForJitNameSuffix, summaryForJitFileName, summaryForJitName } from '@angular/compiler/esm2015/src/aot/util';
const TS = /^(?!.*\.d\.ts$).*\.ts$/;
