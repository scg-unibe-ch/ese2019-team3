 ...
 */
import { rendererTypeName, tokenReference, viewClassName } from '@angular/compiler/esm2015/src/compile_metadata';
import { BindingForm, EventHandlerVars, convertActionBinding, convertPropertyBinding, convertPropertyBindingBuiltins } from '@angular/compiler/esm2015/src/compiler_util/expression_converter';
import { ChangeDetectionStrategy } from '@angular/compiler/esm2015/src/core';
import { Identifiers } from '@angular/compiler/esm2015/src/identifiers';
import { LifecycleHooks } from '@angular/compiler/esm2015/src/lifecycle_reflector';
import { isNgContainer } from '@angular/compiler/esm2015/src/ml_parser/tags';
import * as o from '@angular/compiler/esm2015/src/output/output_ast';
import { convertValueToOutputAst } from '@angular/compiler/esm2015/src/output/value_util';
import { ElementAst, EmbeddedTemplateAst, NgContentAst, templateVisitAll } from '@angular/compiler/esm2015/src/template_parser/template_ast';
import { componentFactoryResolverProviderDef, depDef, lifecycleHookToNodeFlag, providerDef } from '@angular/compiler/esm2015/src/view_compiler/provider_compiler';
