...
import { ngfactoryFilePath } from '@angular/compiler/esm2015/src/aot/util';
import { assertArrayOfStrings, assertInterpolationSymbols } from '@angular/compiler/esm2015/src/assertions';
import * as cpl from '@angular/compiler/esm2015/src/compile_metadata';
import { ChangeDetectionStrategy, Type, ViewEncapsulation, createAttribute, createComponent, createHost, createInject, createInjectable, createInjectionToken, createNgModule, createOptional, createSelf, createSkipSelf } from '@angular/compiler/esm2015/src/core';
import { findLast } from '@angular/compiler/esm2015/src/directive_resolver';
import { Identifiers } from '@angular/compiler/esm2015/src/identifiers';
import { getAllLifecycleHooks } from '@angular/compiler/esm2015/src/lifecycle_reflector';
import { CssSelector } from '@angular/compiler/esm2015/src/selector';
import { SyncAsync, ValueTransformer, isPromise, noUndefined, resolveForwardRef, stringify, syntaxError, visitValue } from '@angular/compiler/esm2015/src/util';
