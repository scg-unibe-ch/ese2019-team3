...
import { NUMBER_FORMAT_REGEXP, parseIntAutoRadix } from '@angular/common/esm2015/src/i18n/format_number';
import { NumberFormatStyle } from '@angular/common/esm2015/src/i18n/locale_data_api';
import { invalidPipeArgumentError } from '@angular/common/esm2015/src/pipes/invalid_pipe_argument_error';
import { NumberFormatter } from '@angular/common/esm2015/src/pipes/deprecated/intl';
/**
 * @param {?} pipe
 * @param {?} locale
 * @param {?} value
