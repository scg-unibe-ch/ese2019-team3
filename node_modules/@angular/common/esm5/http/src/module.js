...
import { HttpBackend, HttpHandler } from '@angular/common/esm5/http/src/backend';
import { HttpClient } from '@angular/common/esm5/http/src/client';
import { HTTP_INTERCEPTORS, HttpInterceptorHandler, NoopInterceptor } from '@angular/common/esm5/http/src/interceptor';
import { JsonpCallbackContext, JsonpClientBackend, JsonpInterceptor } from '@angular/common/esm5/http/src/jsonp';
import { BrowserXhr, HttpXhrBackend, XhrFactory } from '@angular/common/esm5/http/src/xhr';
import { HttpXsrfCookieExtractor, HttpXsrfInterceptor, HttpXsrfTokenExtractor, XSRF_COOKIE_NAME, XSRF_HEADER_NAME } from '@angular/common/esm5/http/src/xsrf';
/**
